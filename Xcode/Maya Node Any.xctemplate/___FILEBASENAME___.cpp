...
MTypeId ___VARIABLE_className:identifier___::id(___VARIABLE_nodeID___) ;

//-----------------------------------------------------------------------------
//- Attributes
MObject ___VARIABLE_className:identifier___::attr1 ;
MObject ___VARIABLE_className:identifier___::attr2 ;

MStatus ___VARIABLE_className:identifier___::initialize () {
...
MStatus ___VARIABLE_className:identifier___::registerMe (MFnPlugin &plugin) {
	return (plugin.registerNode (_T("___VARIABLE_nodeName___"), ___VARIABLE_className:identifier___::id, ___VARIABLE_className:identifier___::creator, ___VARIABLE_className:identifier___::initialize)) ;
}

MStatus ___VARIABLE_className:identifier___::unregisterMe (MFnPlugin &plugin) {
	return (plugin.deregisterNode (___VARIABLE_className:identifier___::id)) ;
}

//-----------------------------------------------------------------------------
MStatus ___VARIABLE_className:identifier___::compute (const MPlug &plug, MDataBlock &data) {
