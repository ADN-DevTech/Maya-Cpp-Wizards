...
MTypeId ___VARIABLE_nodeClassName:identifier___::id(___VARIABLE_nodeID___) ;

//-----------------------------------------------------------------------------
//- Attributes
MObject ___VARIABLE_nodeClassName:identifier___::attr1 ;
MObject ___VARIABLE_nodeClassName:identifier___::attr2 ;

MStatus ___VARIABLE_nodeClassName:identifier___::initialize () {
...
MStatus ___VARIABLE_nodeClassName:identifier___::registerMe (MFnPlugin &plugin) {
	return (plugin.registerNode (_T("___VARIABLE_nodeName___"), ___VARIABLE_nodeClassName:identifier___::id, ___VARIABLE_nodeClassName:identifier___::creator, ___VARIABLE_nodeClassName:identifier___::initialize)) ;
}

MStatus ___VARIABLE_nodeClassName:identifier___::unregisterMe (MFnPlugin &plugin) {
	return (plugin.deregisterNode (___VARIABLE_nodeClassName:identifier___::id)) ;
}

//-----------------------------------------------------------------------------
MStatus ___VARIABLE_nodeClassName:identifier___::compute (const MPlug &plug, MDataBlock &data) {
